...
function Install-VCRedist {
    ...
    try {
        ...
        Write-Host ("ERROR: Failed to install VC++ Redistributables: {0}" -f $_) -ForegroundColor Red
...
function Install-MSIXPackage {
    ...
    try {
        ...
        Write-Host ("ERROR: Failed to install {0} via MSIX: {1}" -f $Name, $_) -ForegroundColor Red
        return $false
    }
}
...
function Start-MSIXApp {
    ...
    try {
        ...
        Write-Host ("WARNING: Could not launch {0}: {1}" -f $AppName, $_) -ForegroundColor Yellow
...
function Install-MicaForEveryone {
    ...
    try {
        ...
        $configLines = @(
            ...
            ''
            '# Global default: Acrylic for ALL applications'
            'Global {'
            ...
            '}'
            ''
            '# File Explorer - Enhanced Acrylic with extended frame'
            'Class: "CabinetWClass" {'
            '    BackdropPreference = Acrylic'
            '    TitleBarColor = System'
            ...
            'Process: "notepad" { BackdropPreference = Acrylic }'
            'Process: "notepad++" { BackdropPreference = Acrylic }'
            'Process: "Code" { BackdropPreference = Acrylic }'
            'Process: "WindowsTerminal" { BackdropPreference = Acrylic }'
            'Process: "pwsh" { BackdropPreference = Acrylic }'
            'Process: "powershell" { BackdropPreference = Acrylic }'
            'Process: "SystemSettings" { BackdropPreference = Acrylic }'
            'Process: "Taskmgr" { BackdropPreference = Acrylic }'
            'Process: "msedge" { BackdropPreference = Acrylic }'
            'Process: "mspaint" { BackdropPreference = Acrylic }'
            'Process: "SnippingTool" { BackdropPreference = Acrylic }'
            ''
            '# Console Applications - Enhanced'
        ...
        Write-Host ("ERROR: Failed to install MicaForEveryone: {0}" -f $_) -ForegroundColor Red
        return $false
    }
}
...
function Install-TranslucentTB {
    ...
    try {
        ...
        Write-Host ("ERROR: Failed to install TranslucentTB: {0}" -f $_) -ForegroundColor Red
        return $false
    }
}
...
function Install-ExplorerBlurMica {
    ...
    try {
        ...
        try {
            ...
            Write-Host ("WARNING: Could not register DLL: {0}" -f $_) -ForegroundColor Yellow
        ...
        Write-Host ("ERROR: Failed to install ExplorerBlurMica: {0}" -f $_) -ForegroundColor Red
        return $false
    } finally {
        # Cleanup
...
function Uninstall-GlassDesktop {
    ...
    try {
        ...
        Write-Host ("Failed to uninstall MicaForEveryone: {0}" -f $_) -ForegroundColor Red
    }
    ...
    try {
        ...
        Write-Host ("Failed to uninstall TranslucentTB: {0}" -f $_) -ForegroundColor Red
    }
    ...
    try {
        ...
        Write-Host ("Failed to uninstall ExplorerBlurMica: {0}" -f $_) -ForegroundColor Red
    }
